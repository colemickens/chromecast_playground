// Very imcomplete ttml (http://www.w3.org/TR/ttaf1-dfxp/) parser,
// proof of concept
(function() {
  'use strict';
  ...
  var Ttml = function(ttmlData) {
    this.ttml_ = ttmlData;
    // TODO (afontan) Grab the real frame rate
    this.frameRate_ = 30;
  };
  ...
  // TODO (afontan): For now we will remove all markup and just return
  // plain text
