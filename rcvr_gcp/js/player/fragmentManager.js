...
(function() {
  ...
  FragmentManager.prototype.makeXHR = function(isInitSegment) {
    ...
    if (isInitSegment) {
      // TODO (afontan): This makes the assumption that the
  ...
  FragmentManager.prototype.tick = function(currentTime) {
    ...
    if (this.fragmentRequest_) {
      ...
      if (nextTime !== null) {
        ...
        //TODO (afontan) Rework low buffering protection artifacts
        var low_buffering_modifier = 0;
