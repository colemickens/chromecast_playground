...
/**
 * @fileoverview Class to process BMFF for Smooth Streaming.
 *
...
(function() {
  ...
  //Add esds
  //TODO:CodecPrivateData, SamplingRate, Channels
        ...
        function(mInfo, dv, a8, pos) {
          pos = add_array(mInfo, dv, a8, pos,
              [0x00, 0x00, 0x00, 0x00, 0x03, 0x19, 0x00, 0x01, 0x00, 0x04,
               ...
               0x00, 0x00, 0x00, 0x00, 0x05, 0x02, 0x12, 0x10, 0x06, 0x01,
               0x02]);
          // TODO SPS, PPS
          return pos;
        }
  ...
  function add_tenc(mInfo, dv, a8, pos) {
    return add_box(mInfo, dv, a8, pos, 'tenc',
        function(mInfo, dv, a8, pos) {
          ...
          pos++;
          // default KID
          // NOTE: HACK We need to provide the proper endianess as YouTube
  ...
  //Add mp4a or enca
  //TODO: SamplingRate, Channels, BitsPerSample, PacketSize
  ...
  function add_stsd(mInfo, dv, a8, pos) {
    return add_box(mInfo, dv, a8, pos, 'stsd',
        function(mInfo, dv, a8, pos) {
          // TODO: The last byte here is 0x02 in the oops encrypted one.
          // Ignore for now. 
          pos = add_array(mInfo, dv, a8, pos,
  ...
  function add_stbl(mInfo, dv, a8, pos) {
    return add_box(mInfo, dv, a8, pos, 'stbl',
        function(mInfo, dv, a8, pos) {
          ...
          // TODO?? We treat stts, stsc, stco, stsz, stss as a blob
          // In audio there is no stss
          if (mInfo.mime !== 'audio/mp4') {
            pos = add_array(mInfo, dv, a8, pos,
  ...
  function add_tkhd(mInfo, dv, a8, pos) {
    return add_box(mInfo, dv, a8, pos, 'tkhd',
        function(mInfo, dv, a8, pos) {
          ...
          // TODO: Verify the actual length 32/16 bits (but the position
          // should be fine)
  ...
  function createSSInit(mInfo) {
    // TODO verify that the 20000 buffer is enough for any init segment
    // Currently it is so large due to the PlayReady header embedded license
  ...
  //Add mdat_enc
  //TODO: aux info type?? Assumes a single trun
  ...
  function add_saio(mInfo, dv, a8, pos) {
    return add_box(mInfo, dv, a8, pos, 'saio',
        function(mInfo, dv, a8, pos) {
          pos = add_array(mInfo, dv, a8, pos,
              [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01]);
          // TODO: Assuming mdat is inmediately after saio
  ...
  function createNewMoof(ab) {
    ...
    // TODO: Assumption flags is 2 so the uuid does not
    ...
    // New buffer
    // TODO: Calculate extra size needed
    var extraSize = 200;
  ...
  // TODO (afontan): Optimize. Right now is not memory efficient as we prefer
  // easy debugging
  // TODO: Revisit wild assumptions in the order and type of boxes
